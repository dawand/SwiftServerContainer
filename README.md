...
A server container with Swift environment and a Vapor websocket server to handle requests from MAMoC (https://github.com/dawand/MobileEdgeCloud) client applications
